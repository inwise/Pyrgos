...
if __name__ == '__main__':
    ...
    try:
        ...
        positions_col = forest_position_maker.make_positions(df)
        ...
        logfile.close()
        # plotting.draw_strategy_performance(df, my_data_folder + my_data_filename, label='forest reg - ' + df['<TICKER>'][0])
        plotting.draw_multiplot(df, my_data_folder + my_data_filename, label='forest reg')
