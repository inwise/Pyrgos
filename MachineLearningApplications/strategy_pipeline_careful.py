import pandas as pd
import position_maker_modified
...
if __name__ == '__main__':
    ...
    try:
        ...
        positions_col = position_maker_modified.make_positions(df)
        ...
        logfile.close()
        # plotting.draw_strategy_performance(df, my_data_folder + my_data_filename, label='careful trendfollow - ' + df['<TICKER>'][0])
        plotting.draw_multiplot(df, my_data_folder + my_data_filename, label='careful trendfollow')
