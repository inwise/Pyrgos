...
def put_price(kappa, theta, sigma, rho, v0, r, t, s0, k):
    # через паритет
    c = call_price(kappa, theta, sigma, rho, v0, r, t, s0, k)
    return c-s0+k*exp(-r*t)
...
if __name__ == '__main__':
    ...
    for k in K:
        ...
        imp_vol = np.append(imp_vol, bs.implied_volatility(price, s0, k, T, r, 'C'))
